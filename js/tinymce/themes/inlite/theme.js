...
var inlite = (function () {
  ...
  var $_3bz92g16ijdxlf2km = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_bfc1g216mjdxlf2kv.fromClientRect(clientRect)) : null;
  };
  var $_1istr616ljdxlf2ks = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          return $_99gzl816kjdxlf2kq.result(predicateIds[i].id, $_1istr616ljdxlf2ks.getElementRect(editor, element));
        }
      }
      return null;
    };
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_99gzl816kjdxlf2kq.result(predicateIds[x].id, $_1istr616ljdxlf2ks.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        return $_99gzl816kjdxlf2kq.result(id, $_1istr616ljdxlf2ks.getSelectionRect(editor));
      }
      return null;
    };
  };
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_6xt6ii16vjdxlf2lc.isArray(value)) {
      return value;
    } else if ($_6xt6ii16vjdxlf2lc.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_6xt6ii16vjdxlf2lc.isBoolean(value)) {
  ...
  var $_6yfsp616ujdxlf2l9 = {
    getStringOr: getByTypeOr($_6xt6ii16vjdxlf2lc.isString),
    getBoolOr: getByTypeOr($_6xt6ii16vjdxlf2lc.isBoolean),
    getNumberOr: getByTypeOr($_6xt6ii16vjdxlf2lc.isNumber),
    getHandlerOr: getByTypeOr($_6xt6ii16vjdxlf2lc.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_6xt6ii16vjdxlf2lc.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_bfc1g216mjdxlf2kv.toClientRect(targetRect),
        contentAreaRect: $_bfc1g216mjdxlf2kv.toClientRect(contentAreaRect),
        panelRect: $_bfc1g216mjdxlf2kv.toClientRect(panelRect)
      });
      return $_bfc1g216mjdxlf2kv.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_6yfsp616ujdxlf2l9.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_6yfsp616ujdxlf2l9.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_6yfsp616ujdxlf2l9.getHandlerOr(editor, 'inline_toolbar_position_handler', $_5g4gmr16wjdxlf2lf.defaultHandler);
  };
  ...
  var fireSkinLoaded$1 = function (editor, callback) {
    var done = function () {
      ...
      $_e0i8kt16rjdxlf2l5.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_45ejac16sjdxlf2l6.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded$1(editor, callback);
    };
    if ($_45ejac16sjdxlf2l6.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_7eg0rc16qjdxlf2l3 = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_3bz92g16ijdxlf2km.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_a0g73516njdxlf2kx.fromContextToolbars(toolbars);
    result = $_99gzl816kjdxlf2kq.match(editor, [
      $_88z6in16jjdxlf2ko.element(elements[0], contextToolbarsPredicateIds),
      $_65uacj16pjdxlf2l0.textSelection('text'),
      $_65uacj16pjdxlf2l0.emptyTextBlock(elements, 'insert'),
      $_88z6in16jjdxlf2ko.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = $_99gzl816kjdxlf2kq.match(editor, [$_65uacj16pjdxlf2l0.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_7eg0rc16qjdxlf2l3.load(editor, function () {
  ...
  var $_26nmks16ejdxlf2kh = { renderUI: renderUI };
  ...
  var never$1 = $_ev2ptn171jdxlf2md.never;
  var always$1 = $_ev2ptn171jdxlf2md.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_ev2ptn171jdxlf2md.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self.borderBox = $_dc2am9178jdxlf2o9.parseBox(settings.border);
      self.paddingBox = $_dc2am9178jdxlf2o9.parseBox(settings.padding);
      self.marginBox = $_dc2am9178jdxlf2o9.parseBox(settings.margin);
      if (settings.hidden) {
        self.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_6y2jpt17gjdxlf2pa.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self.borderBox = self.borderBox || $_dc2am9178jdxlf2o9.measureBox(elm, 'border');
      self.paddingBox = self.paddingBox || $_dc2am9178jdxlf2o9.measureBox(elm, 'padding');
      self.marginBox = self.marginBox || $_dc2am9178jdxlf2o9.measureBox(elm, 'margin');
    ...
    reflow: function () {
      $_c16shi17fjdxlf2p7.remove(this);
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_6y2jpt17gjdxlf2pa.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var $_5ayhaa17hjdxlf2pg = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_6y2jpt17gjdxlf2pa.getUiContainer(self);
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_6y2jpt17gjdxlf2pa.inheritUiContainer(this, this._tooltip);
  ...
  function NotificationManagerImpl (editor) {
    ...
    var prePositionNotifications = function (notifications) {
      $_g56bww16zjdxlf2ls.each(notifications, function (notification) {
    ...
    var positionNotifications = function (notifications) {
      if (notifications.length > 0) {
        ...
        $_g56bww16zjdxlf2ls.each(notifications, function (notification, index) {
          if (index > 0) {
  ...
  var Window = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self._fullscreen) {
        ...
        if (!state) {
          self.borderBox = $_dc2am9178jdxlf2o9.parseBox(self.settings.border);
          ...
          self.borderBox = $_dc2am9178jdxlf2o9.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_26nmks16ejdxlf2kh.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var $_82ooht16djdxlf2ke = { get: get };
  ...
  var unsafe = function (name, scope) {
    return $_a3jd7l180jdxlf2t6.resolve(name, scope);
  };
  ...
  var $_coph3w17zjdxlf2t2 = { getOrDie: getOrDie };

  function FileReader () {
    var f = $_coph3w17zjdxlf2t2.getOrDie('FileReader');
    return new f();
  }
  ...
  var $_c8az7817xjdxlf2sv = { blobToBase64: blobToBase64 };
  ...
  var $_2v4pk5183jdxlf2ta = { pickFile: pickFile };
  ...
  var $_eko3s8185jdxlf2th = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_bnh8ni187jdxlf2to.create(dom, selection.getRng());
    Tools.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_bnh8ni187jdxlf2to.resolve(dom, bookmark));
  };
  ...
  var $_6ba31j186jdxlf2tj = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_eko3s8185jdxlf2th.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_6ba31j186jdxlf2tj.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_672tnb184jdxlf2te.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name_1 = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_2v4pk5183jdxlf2ta.pickFile().then(function (files) {
          var blob = files[0];
          $_c8az7817xjdxlf2sv.blobToBase64(blob).then(function (base64) {
            $_672tnb184jdxlf2te.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_672tnb184jdxlf2te.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_2n5lpo17wjdxlf2ss = { addToEditor: addToEditor };
  ...
  var $_8lq0it18bjdxlf2u2 = { getUiContainerDelta: getUiContainerDelta$1 };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_7hifh818djdxlf2uc.isAbsolute(href) && $_7hifh818djdxlf2uc.isDomainLike(href) ? askAboutPrefix(editor, href) : Promise.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_672tnb184jdxlf2te.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_672tnb184jdxlf2te.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_3ru0kv18cjdxlf2u7 = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_6xt6ii16vjdxlf2lc.isArray(items)) {
      return items;
    } else if ($_6xt6ii16vjdxlf2lc.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
  ...
  var $_da10hr18ejdxlf2ue = { create: create$2 };

  function Panel$1 () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return Tools.map(toolbars, function (toolbar) {
        return $_da10hr18ejdxlf2ue.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_da10hr18ejdxlf2ue.create(editor, 'text', $_45ejac16sjdxlf2l6.getTextSelectionToolbarItems(editor)),
        $_da10hr18ejdxlf2ue.create(editor, 'insert', $_45ejac16sjdxlf2l6.getInsertToolbarItems(editor)),
        $_3ru0kv18cjdxlf2u7.createQuickLinkForm(editor, hide)
      ]);
      return Factory.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_45ejac16sjdxlf2l6.getPositionHandler(editor);
      contentAreaRect = $_1istr616ljdxlf2ks.getContentAreaRect(editor);
      panelRect = DOMUtils.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_5g4gmr16wjdxlf2lf.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_5g4gmr16wjdxlf2lf.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_8lq0it18bjdxlf2u2.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_5g4gmr16wjdxlf2lf.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_1istr616ljdxlf2ks.getContentAreaRect(editor);
        panelRect = DOMUtils.DOM.getRect(panel.getEl());
        result = $_5g4gmr16wjdxlf2lf.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_5g4gmr16wjdxlf2lf.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_e0i8kt16rjdxlf2l5.fireBeforeRenderUI(editor);
  ...
  var $_bozdxt191jdxlf2xw = { generate: generate };
  ...
  var fromDom = function (node) {
    ...
    return { dom: $_ev2ptn171jdxlf2md.constant(node) };
  };
  var fromPoint = function (doc, x, y) {
    return Option.from(doc.dom().elementFromPoint(x, y)).map(fromDom);
  };
  var $_fg2uw4192jdxlf2xz = {
    fromHtml: fromHtml,
    fromTag: fromTag,
    fromText: fromText,
    fromDom: fromDom,
  ...
  var $_a7jlh5196jdxlf2ys = { cached: cached };

  var $_512otj198jdxlf2yw = {
    ATTRIBUTE: 2,
    CDATA_SECTION: 4,
    COMMENT: 8,
    DOCUMENT: 9,
  ...
  var isComment = function (element) {
    return type(element) === $_512otj198jdxlf2yw.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_512otj198jdxlf2yw.ELEMENT);
  var isText = isType$1($_512otj198jdxlf2yw.TEXT);
  var isDocument = isType$1($_512otj198jdxlf2yw.DOCUMENT);
  var $_ehmooj197jdxlf2yu = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_ehmooj197jdxlf2yu.isText(element) ? element.dom().parentNode : element.dom();
    return dom !== undefined && dom !== null && dom.ownerDocument.body.contains(dom);
  };
  var body = $_a7jlh5196jdxlf2ys.cached(function () {
    return getBody($_fg2uw4192jdxlf2xz.fromDom(document));
  });
  var getBody = function (doc) {
    var body = doc.dom().body;
    if (body === null || body === undefined)
      throw 'Body is not available yet';
    return $_fg2uw4192jdxlf2xz.fromDom(body);
  };
  var $_au1jdh195jdxlf2yo = {
    body: body,
    getBody: getBody,
    inBody: inBody
  };
  ...
  function Immutable () {
    ...
    return function () {
      ...
      var struct = {};
      $_g56bww16zjdxlf2ls.each(fields, function (name, i) {
        struct[name] = $_ev2ptn171jdxlf2md.constant(values[i]);
      });
      return struct;
    };
  }
  ...
  var validateStrArr = function (label, array) {
    if (!$_dk5a7k19ajdxlf2zf.isArray(array))
      throw new Error('The ' + label + ' fields must be an array. Was: ' + array + '.');
    $_g56bww16zjdxlf2ls.each(array, function (a) {
      if (!$_dk5a7k19ajdxlf2zf.isString(a))
  ...
  var checkDupes = function (everything) {
    ...
    var dupe = $_g56bww16zjdxlf2ls.find(sorted, function (s, i) {
  ...
  function MixedBag (required, optional) {
    ...
    $_e821dq19fjdxlf2zv.validateStrArr('required', required);
    $_e821dq19fjdxlf2zv.validateStrArr('optional', optional);
    $_e821dq19fjdxlf2zv.checkDupes(everything);
    return function (obj) {
      var keys = $_443c5f19ejdxlf2zq.keys(obj);
      var allReqd = $_g56bww16zjdxlf2ls.forall(required, function (req) {
        return $_g56bww16zjdxlf2ls.contains(keys, req);
      });
      if (!allReqd)
        $_e821dq19fjdxlf2zv.reqMessage(required, keys);
      var unsupported = $_g56bww16zjdxlf2ls.filter(keys, function (key) {
        return !$_g56bww16zjdxlf2ls.contains(everything, key);
      });
      if (unsupported.length > 0)
        $_e821dq19fjdxlf2zv.unsuppMessage(unsupported);
      var r = {};
      $_g56bww16zjdxlf2ls.each(required, function (req) {
        r[req] = $_ev2ptn171jdxlf2md.constant(obj[req]);
      });
      $_g56bww16zjdxlf2ls.each(optional, function (opt) {
        r[opt] = $_ev2ptn171jdxlf2md.constant(Object.prototype.hasOwnProperty.call(obj, opt) ? Option.some(obj[opt]) : Option.none());
      });
      return r;
    };
  }

  var $_5f4sjr19bjdxlf2zi = {
    immutable: Immutable,
  ...
  var $_bt0kr719gjdxlf2zz = { toArray: toArray };

  var node = function () {
    var f = $_coph3w17zjdxlf2t2.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_bqmdeb19mjdxlf30p.unknown()
    });
  };
  ...
  var $_d03dhu19ljdxlf30k = {
    unknown: unknown$1,
    nu: nu$1,
    edge: $_ev2ptn171jdxlf2md.constant(edge),
    chrome: $_ev2ptn171jdxlf2md.constant(chrome),
    ie: $_ev2ptn171jdxlf2md.constant(ie),
    opera: $_ev2ptn171jdxlf2md.constant(opera),
    firefox: $_ev2ptn171jdxlf2md.constant(firefox),
    safari: $_ev2ptn171jdxlf2md.constant(safari)
  };
  ...
  var $_7q2q1219njdxlf30t = {
    unknown: unknown$2,
    nu: nu$2,
    windows: $_ev2ptn171jdxlf2md.constant(windows$1),
    ios: $_ev2ptn171jdxlf2md.constant(ios),
    android: $_ev2ptn171jdxlf2md.constant(android),
    linux: $_ev2ptn171jdxlf2md.constant(linux),
    osx: $_ev2ptn171jdxlf2md.constant(osx),
    solaris: $_ev2ptn171jdxlf2md.constant(solaris),
    freebsd: $_ev2ptn171jdxlf2md.constant(freebsd)
  };
  ...
  function DeviceType (os, browser, userAgent) {
    ...
    return {
      isiPad: $_ev2ptn171jdxlf2md.constant(isiPad),
      isiPhone: $_ev2ptn171jdxlf2md.constant(isiPhone),
      isTablet: $_ev2ptn171jdxlf2md.constant(isTablet),
      isPhone: $_ev2ptn171jdxlf2md.constant(isPhone),
      isTouch: $_ev2ptn171jdxlf2md.constant(isTouch),
      isAndroid: os.isAndroid,
      isiOS: os.isiOS,
      isWebView: $_ev2ptn171jdxlf2md.constant(iOSwebview)
    };
  }

  var detect$1 = function (candidates, userAgent) {
    var agent = String(userAgent).toLowerCase();
    return $_g56bww16zjdxlf2ls.find(candidates, function (candidate) {
      return candidate.search(agent);
    });
  };
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_bqmdeb19mjdxlf30p.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_bqmdeb19mjdxlf30p.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_bf4llj19sjdxlf320.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_bf4llj19sjdxlf320.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_bf4llj19sjdxlf320.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_bf4llj19sjdxlf320.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_2dq72119tjdxlf323.head(str).bind(function (head) {
      return $_2dq72119tjdxlf323.tail(str).map(function (tail) {
  ...
  var checkContains = function (target) {
    return function (uastring) {
      return $_9oa9qu19rjdxlf31v.contains(uastring, target);
    };
  };
  var browsers = [
    {
      ...
      search: function (uastring) {
        var monstrosity = $_9oa9qu19rjdxlf31v.contains(uastring, 'edge/') && $_9oa9qu19rjdxlf31v.contains(uastring, 'chrome') && $_9oa9qu19rjdxlf31v.contains(uastring, 'safari') && $_9oa9qu19rjdxlf31v.contains(uastring, 'applewebkit');
        return monstrosity;
      }
    },
    {
      ...
      search: function (uastring) {
        return $_9oa9qu19rjdxlf31v.contains(uastring, 'chrome') && !$_9oa9qu19rjdxlf31v.contains(uastring, 'chromeframe');
      }
    },
    {
      name: 'IE',
      ...
      search: function (uastring) {
        return $_9oa9qu19rjdxlf31v.contains(uastring, 'msie') || $_9oa9qu19rjdxlf31v.contains(uastring, 'trident');
      }
    },
    {
      name: 'Opera',
    ...
    },
    {
      ...
      search: function (uastring) {
        return ($_9oa9qu19rjdxlf31v.contains(uastring, 'safari') || $_9oa9qu19rjdxlf31v.contains(uastring, 'mobile/')) && $_9oa9qu19rjdxlf31v.contains(uastring, 'applewebkit');
      }
    }
  ];
  var oses = [
    ...
    },
    {
      name: 'iOS',
      search: function (uastring) {
        return $_9oa9qu19rjdxlf31v.contains(uastring, 'iphone') || $_9oa9qu19rjdxlf31v.contains(uastring, 'ipad');
      },
      versionRegexes: [
        /.*?version\/\ ?([0-9]+)\.([0-9]+).*/,
        /.*cpu os ([0-9]+)_([0-9]+).*/,
  ...
  var $_buv9lu19qjdxlf319 = {
    browsers: $_ev2ptn171jdxlf2md.constant(browsers),
    oses: $_ev2ptn171jdxlf2md.constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_buv9lu19qjdxlf319.browsers();
    var oses = $_buv9lu19qjdxlf319.oses();
    var browser = $_9f1ri819pjdxlf314.detectBrowser(browsers, userAgent).fold($_d03dhu19ljdxlf30k.unknown, $_d03dhu19ljdxlf30k.nu);
    var os = $_9f1ri819pjdxlf314.detectOs(oses, userAgent).fold($_7q2q1219njdxlf30t.unknown, $_7q2q1219njdxlf30t.nu);
  ...
  var $_8zlrhh19kjdxlf30i = { detect: detect$2 };

  var detect$3 = $_a7jlh5196jdxlf2ys.cached(function () {
    var userAgent = navigator.userAgent;
    return $_8zlrhh19kjdxlf30i.detect(userAgent);
  });
  var $_2buq5b19jjdxlf30f = { detect: detect$3 };

  var ELEMENT = $_512otj198jdxlf2yw.ELEMENT;
  var DOCUMENT = $_512otj198jdxlf2yw.DOCUMENT;
  ...
  var all = function (selector, scope) {
    ...
    return bypassSelector(base) ? [] : $_g56bww16zjdxlf2ls.map(base.querySelectorAll(selector), $_fg2uw4192jdxlf2xz.fromDom);
  };
  var one = function (selector, scope) {
    var base = scope === undefined ? document : scope.dom();
    return bypassSelector(base) ? Option.none() : Option.from(base.querySelector(selector)).map($_fg2uw4192jdxlf2xz.fromDom);
  };
  var $_5vnf1e19ujdxlf326 = {
    all: all,
    is: is,
    one: one
  };
  ...
  var member = function (element, elements) {
    return $_g56bww16zjdxlf2ls.exists(elements, $_ev2ptn171jdxlf2md.curry(eq, element));
  };
  ...
  var ieContains = function (e1, e2) {
    return $_7mq4a919ijdxlf30c.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_2buq5b19jjdxlf30f.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_asyux119hjdxlf302 = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_5vnf1e19ujdxlf326.is
  };

  var owner = function (element) {
    return $_fg2uw4192jdxlf2xz.fromDom(element.dom().ownerDocument);
  };
  var documentElement = function (element) {
    var doc = owner(element);
    return $_fg2uw4192jdxlf2xz.fromDom(doc.dom().documentElement);
  };
  var defaultView = function (element) {
    var el = element.dom();
    var defaultView = el.ownerDocument.defaultView;
    return $_fg2uw4192jdxlf2xz.fromDom(defaultView);
  };
  var parent$1 = function (element) {
    var dom = element.dom();
    return Option.from(dom.parentNode).map($_fg2uw4192jdxlf2xz.fromDom);
  };
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      var kin = children(p);
      return $_g56bww16zjdxlf2ls.findIndex(kin, function (elem) {
        return $_asyux119hjdxlf302.eq(element, elem);
      });
    });
  };
  var parents = function (element, isRoot) {
    var stop = $_dk5a7k19ajdxlf2zf.isFunction(isRoot) ? isRoot : $_ev2ptn171jdxlf2md.constant(false);
    var dom = element.dom();
    var ret = [];
    while (dom.parentNode !== null && dom.parentNode !== undefined) {
      var rawParent = dom.parentNode;
      var parent = $_fg2uw4192jdxlf2xz.fromDom(rawParent);
      ret.push(parent);
      if (stop(parent) === true)
        break;
      else
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return $_g56bww16zjdxlf2ls.filter(elements, function (x) {
        return !$_asyux119hjdxlf302.eq(element, x);
      });
    };
  ...
  var offsetParent = function (element) {
    var dom = element.dom();
    return Option.from(dom.offsetParent).map($_fg2uw4192jdxlf2xz.fromDom);
  };
  var prevSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.previousSibling).map($_fg2uw4192jdxlf2xz.fromDom);
  };
  var nextSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.nextSibling).map($_fg2uw4192jdxlf2xz.fromDom);
  };
  var prevSiblings = function (element) {
    return $_g56bww16zjdxlf2ls.reverse($_bt0kr719gjdxlf2zz.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_bt0kr719gjdxlf2zz.toArray(element, nextSibling);
  };
  var children = function (element) {
    var dom = element.dom();
    return $_g56bww16zjdxlf2ls.map(dom.childNodes, $_fg2uw4192jdxlf2xz.fromDom);
  };
  var child = function (element, index) {
    var children = element.dom().childNodes;
    return Option.from(children[index]).map($_fg2uw4192jdxlf2xz.fromDom);
  };
  ...
  var spot = $_5f4sjr19bjdxlf2zi.immutable('element', 'offset');
  var leaf = function (element, offset) {
    var cs = children(element);
    return cs.length > 0 && offset < cs.length ? spot(cs[offset], 0) : spot(element, offset);
  };
  var $_4r1qr6199jdxlf2yz = {
    owner: owner,
  ...
  var all$1 = function (predicate) {
    return descendants($_au1jdh195jdxlf2yo.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return $_g56bww16zjdxlf2ls.filter($_4r1qr6199jdxlf2yz.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return $_g56bww16zjdxlf2ls.filter($_4r1qr6199jdxlf2yz.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return $_g56bww16zjdxlf2ls.filter($_4r1qr6199jdxlf2yz.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    $_g56bww16zjdxlf2ls.each($_4r1qr6199jdxlf2yz.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_5vnf1e19ujdxlf326.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_62d5q6194jdxlf2yk.ancestors(scope, function (e) {
      return $_5vnf1e19ujdxlf326.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_62d5q6194jdxlf2yk.siblings(scope, function (e) {
      return $_5vnf1e19ujdxlf326.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_62d5q6194jdxlf2yk.children(scope, function (e) {
      return $_5vnf1e19ujdxlf326.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_5vnf1e19ujdxlf326.all(selector, scope);
  };
  var $_80fv62193jdxlf2y6 = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return $_g56bww16zjdxlf2ls.map($_80fv62193jdxlf2y6.descendants($_fg2uw4192jdxlf2xz.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var getOrGenerateId = function (elm) {
    return elm.id ? elm.id : $_bozdxt191jdxlf2xw.generate('h');
  };
  ...
  var anchorTarget = function (elm) {
    ...
    return create$3('anchor', anchorText ? anchorText : '#' + anchorId, '#' + anchorId, 0, $_ev2ptn171jdxlf2md.noop);
  };
  var getHeaderTargets = function (elms) {
    return $_g56bww16zjdxlf2ls.map($_g56bww16zjdxlf2ls.filter(elms, isValidHeader), headerTarget);
  };
  var getAnchorTargets = function (elms) {
    return $_g56bww16zjdxlf2ls.map($_g56bww16zjdxlf2ls.filter(elms, isValidAnchor), anchorTarget);
  };
  ...
  var find$3 = function (elm) {
    ...
    return $_g56bww16zjdxlf2ls.filter(getHeaderTargets(elms).concat(getAnchorTargets(elms)), hasTitle);
  };
  var $_8tag7m190jdxlf2xl = { find: find$3 };
  ...
  var staticMenuItem = function (title, url) {
    return {
      ...
      value: {
        title: title,
        url: url,
        attach: $_ev2ptn171jdxlf2md.noop
      }
    };
  };
  var isUniqueUrl = function (url, targets) {
    var foundTarget = $_g56bww16zjdxlf2ls.exists(targets, function (target) {
  ...
  var createMenuItems = function (term, targets, fileType, editorSettings) {
    ...
    var fromHistoryMenuItems = function (history) {
      ...
      var uniqueHistory = $_g56bww16zjdxlf2ls.filter(historyItems, function (url) {
    ...
    var fromMenuItems = function (type) {
      var filteredTargets = $_g56bww16zjdxlf2ls.filter(targets, function (target) {
    ...
    var join = function (items) {
      return $_g56bww16zjdxlf2ls.foldl(items, function (a, b) {
  ...
  var addToHistory = function (url, fileType) {
    ...
    if (items) {
      if ($_g56bww16zjdxlf2ls.indexOf(items, url) === -1) {
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_8tag7m190jdxlf2xl.find(bodyElm);
  ...
  function ClosestOrAncestor (is, ancestor, scope, a, isRoot) {
    return is(scope, a) ? Option.some(scope) : $_dk5a7k19ajdxlf2zf.isFunction(isRoot) && isRoot(scope) ? Option.none() : ancestor(scope, a, isRoot);
  }

  var first$1 = function (predicate) {
    return descendant($_au1jdh195jdxlf2yo.body(), predicate);
  };
  var ancestor = function (scope, predicate, isRoot) {
    ...
    while (element.parentNode) {
      ...
      var el = $_fg2uw4192jdxlf2xz.fromDom(element);
      if (predicate(el))
  ...
  var sibling = function (scope, predicate) {
    ...
    if (!element.parentNode)
      return Option.none();
    return child$1($_fg2uw4192jdxlf2xz.fromDom(element.parentNode), function (x) {
      return !$_asyux119hjdxlf302.eq(scope, x) && predicate(x);
    });
  };
  var child$1 = function (scope, predicate) {
    var result = $_g56bww16zjdxlf2ls.find(scope.dom().childNodes, $_ev2ptn171jdxlf2md.compose(predicate, $_fg2uw4192jdxlf2xz.fromDom));
    return result.map($_fg2uw4192jdxlf2xz.fromDom);
  };
  var descendant = function (scope, predicate) {
    var descend = function (element) {
      for (var i = 0; i < element.childNodes.length; i++) {
        if (predicate($_fg2uw4192jdxlf2xz.fromDom(element.childNodes[i])))
          return Option.some($_fg2uw4192jdxlf2xz.fromDom(element.childNodes[i]));
  ...
  var first$2 = function (selector) {
    return $_5vnf1e19ujdxlf326.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_adawvx1a0jdxlf33d.ancestor(scope, function (e) {
      return $_5vnf1e19ujdxlf326.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_adawvx1a0jdxlf33d.sibling(scope, function (e) {
      return $_5vnf1e19ujdxlf326.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_adawvx1a0jdxlf33d.child(scope, function (e) {
      return $_5vnf1e19ujdxlf326.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_5vnf1e19ujdxlf326.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_5vnf1e19ujdxlf326.is, ancestor$1, scope, selector, isRoot);
  };
  var $_2fco4219zjdxlf339 = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
      ...
      menu: [
        {
          text: 'Left',
          icon: 'alignleft',
          onclick: $_4g1tiv1a3jdxlf348.toggleFormat(editor, 'alignleft')
        },
        {
          text: 'Center',
          icon: 'aligncenter',
          onclick: $_4g1tiv1a3jdxlf348.toggleFormat(editor, 'aligncenter')
        },
        {
          text: 'Right',
          icon: 'alignright',
          onclick: $_4g1tiv1a3jdxlf348.toggleFormat(editor, 'alignright')
        },
        {
          text: 'Justify',
          icon: 'alignjustify',
          onclick: $_4g1tiv1a3jdxlf348.toggleFormat(editor, 'alignjustify')
        }
      ]
    });
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: item[0],
        cmd: item[1],
        onPostRender: $_4g1tiv1a3jdxlf348.postRenderFormat(editor, name)
      });
    });
  };
  var $_e14o4x1a2jdxlf345 = { register: register };
  ...
  var getFontProp = function (propName) {
    return function (rootElm, elm) {
      return Option.from(elm).map($_fg2uw4192jdxlf2xz.fromDom).filter($_ehmooj197jdxlf2yu.isElement).bind(function (element) {
        return getSpecifiedFontProp(propName, rootElm, element.dom()).or(getComputedFontProp(propName, element.dom()));
      }).getOr('');
    };
  };
  var $_3ixy3o1a5jdxlf34j = {
    getFontSize: getFontProp('fontSize'),
    getFontFamily: $_ev2ptn171jdxlf2md.compose(normalizeFontFamily, getFontProp('fontFamily')),
    toPt: toPt
  };
  ...
  var createFontNameListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        var fontFamily = $_3ixy3o1a5jdxlf34j.getFontFamily(editor.getBody(), e.element);
  ...
  var $_ffao0j1a4jdxlf34c = { register: register$1 };
  ...
  var createFontSizeListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        ...
        px = $_3ixy3o1a5jdxlf34j.getFontSize(editor.getBody(), e.element);
        if (px) {
          for (precision = 3; !match && precision >= 0; precision--) {
            pt = $_3ixy3o1a5jdxlf34j.toPt(px, precision);
  ...
  var $_1liyy01a6jdxlf34w = { register: register$2 };
  ...
  var createFormatMenu = function (editor) {
    ...
    return {
      ...
      itemDefaults: {
        ...
        onclick: function () {
          if (this.settings.format) {
            $_4g1tiv1a3jdxlf348.toggleFormat(editor, this.settings.format)();
          }
  ...
  var $_96368x1a7jdxlf352 = { register: register$3 };
      ...
      return {
        ...
        onselect: function (e) {
          if (e.control) {
            ...
            $_4g1tiv1a3jdxlf348.toggleFormat(editor, fmt)();
          }
        },
  ...
  var buildMenuItems = function (editor, blocks) {
    return Tools.map(blocks, function (block) {
      return {
        text: block[0],
        onclick: $_4g1tiv1a3jdxlf348.toggleFormat(editor, block[1]),
        textStyle: function () {
          return editor.formatter.getCssText(block[1]);
        }
      };
  ...
  var $_4fj10j1a8jdxlf35g = { register: register$4 };
  ...
  var createCustomMenuItems = function (editor, names) {
    ...
    if (typeof names === 'string') {
      ...
      return $_g56bww16zjdxlf2ls.flatten(Tools.map(names, function (names) {
  ...
  var trimMenuItems = function (menuItems) {
    var menuItems2 = $_g56bww16zjdxlf2ls.filter(menuItems, function (menuItem, i, menuItems) {
      return !isSeparator(menuItem) || !isSeparator(menuItems[i - 1]);
    });
    return $_g56bww16zjdxlf2ls.filter(menuItems2, function (menuItem, i, menuItems) {
  ...
  var $_12ilbs1a9jdxlf35z = { register: register$5 };
  ...
  var registerFormatButtons = function (editor) {
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: text,
        onPostRender: $_4g1tiv1a3jdxlf348.postRenderFormat(editor, name),
        onclick: $_4g1tiv1a3jdxlf348.toggleFormat(editor, name)
      });
    });
  };
  ...
  var registerMenuItems$1 = function (editor) {
    ...
    editor.addMenuItem('codeformat', {
      text: 'Code',
      icon: 'code',
      onclick: $_4g1tiv1a3jdxlf348.toggleFormat(editor, 'code')
    });
  };
  ...
  var $_69of0r1aajdxlf368 = { register: register$6 };
  ...
  var $_4zt7a91abjdxlf36g = { register: register$7 };
  ...
  var $_9vk9ci1acjdxlf36k = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      Env.container = $_2fco4219zjdxlf339.descendant($_fg2uw4192jdxlf2xz.fromDom(document.body), editor.settings.ui_container).fold($_ev2ptn171jdxlf2md.constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_4fj10j1a8jdxlf35g.register(editor);
    $_e14o4x1a2jdxlf345.register(editor);
    $_69of0r1aajdxlf368.register(editor);
    $_4zt7a91abjdxlf36g.register(editor);
    $_1liyy01a6jdxlf34w.register(editor);
    $_ffao0j1a4jdxlf34c.register(editor);
    $_96368x1a7jdxlf352.register(editor);
    $_9vk9ci1acjdxlf36k.register(editor);
    $_12ilbs1a9jdxlf35z.register(editor);
  };
  var $_bbsjgn19yjdxlf330 = { setup: setup };
  ...
  var Slider = Widget.extend({
    init: function (settings) {
      ...
      self._minValue = $_dk5a7k19ajdxlf2zf.isNumber(settings.minValue) ? settings.minValue : 0;
      self._maxValue = $_dk5a7k19ajdxlf2zf.isNumber(settings.maxValue) ? settings.maxValue : 100;
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_c16shi17fjdxlf2p7,
      Control: Control$1,
      Factory: Factory,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_7q3qcp17tjdxlf2s1,
      Panel: Panel,
      Movable: $_5ayhaa17hjdxlf2pg,
      Resizable: $_33wbep17ujdxlf2s7,
      ...
      FormatControls: $_bbsjgn19yjdxlf330,
  ...
  ThemeManager.add('inlite', function (editor) {
    var panel = Panel$1();
    $_bbsjgn19yjdxlf330.setup(editor);
    $_2n5lpo17wjdxlf2ss.addToEditor(editor, panel);
    return $_82ooht16djdxlf2ke.get(editor, panel);
  });
  function Theme () {
  }
