...
var help = (function () {
  ...
  var never$1 = $_9tol80aqjdxletqr.never;
  var always$1 = $_9tol80aqjdxletqr.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_9tol80aqjdxletqr.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var $_96i6hqasjdxletqy = { shortcuts: shortcuts };
  ...
  var makeTab = function () {
    ...
    var shortcutLisString = $_b6s1vjaojdxletq1.map($_96i6hqasjdxletqy.shortcuts, function (shortcut) {
  ...
  var $_27uihaanjdxletph = { makeTab: makeTab };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_5v41ksaxjdxlets6.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_5v41ksaxjdxlets6.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_5v41ksaxjdxlets6.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_5v41ksaxjdxlets6.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_2fiw2qayjdxlets9.head(str).bind(function (head) {
      return $_2fiw2qayjdxlets9.tail(str).map(function (tail) {
  ...
  var $_a9qk30azjdxletsg = { urls: urls };

  var makeLink = $_9tol80aqjdxletqr.curry($_apgcktawjdxlets0.supplant, '<a href="${url}" target="_blank" rel="noopener">${name}</a>');
  var maybeUrlize = function (editor, key) {
    return $_b6s1vjaojdxletq1.find($_a9qk30azjdxletsg.urls, function (x) {
      return x.key === key;
    }).fold(function () {
  ...
  var getPluginKeys = function (editor) {
    var keys = $_1od5k5avjdxletru.keys(editor.plugins);
    return editor.settings.forced_plugins === undefined ? keys : $_b6s1vjaojdxletq1.filter(keys, $_9tol80aqjdxletqr.not($_9tol80aqjdxletqr.curry($_b6s1vjaojdxletq1.contains, editor.settings.forced_plugins)));
  };
  var pluginLister = function (editor) {
    var pluginKeys = getPluginKeys(editor);
    var pluginLis = $_b6s1vjaojdxletq1.map(pluginKeys, function (key) {
  ...
  var $_82x5u6aujdxletr9 = { makeTab: makeTab$1 };
  ...
  var $_adqma9b0jdxletsk = { makeRow: makeRow };
  ...
  var open = function (editor, pluginUrl) {
    return function () {
      editor.windowManager.open({
        ...
        layout: 'flex',
        body: [
          $_27uihaanjdxletph.makeTab(),
          $_82x5u6aujdxletr9.makeTab(editor)
        ],
        buttons: $_adqma9b0jdxletsk.makeRow(),
  ...
  var $_5s9hv4amjdxletp8 = { open: open };

  var register = function (editor, pluginUrl) {
    editor.addCommand('mceHelp', $_5s9hv4amjdxletp8.open(editor, pluginUrl));
  };
  var $_52opvhaljdxletp4 = { register: register };

  var register$1 = function (editor, pluginUrl) {
    editor.addButton('help', {
      icon: 'help',
      onclick: $_5s9hv4amjdxletp8.open(editor, pluginUrl)
    });
  ...
  var $_b2s4o3b2jdxletso = { register: register$1 };

  PluginManager.add('help', function (editor, pluginUrl) {
    $_b2s4o3b2jdxletso.register(editor, pluginUrl);
    $_52opvhaljdxletp4.register(editor, pluginUrl);
