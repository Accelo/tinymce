...
var preview = (function () {
  ...
  var getPreviewHtml = function (editor) {
    ...
    var contentStyle = $_aohs13i6jdxlevi4.getContentStyle(editor);
  ...
  var open = function (editor) {
    ...
    var dialogWidth = $_aohs13i6jdxlevi4.getPreviewDialogWidth(editor);
    var dialogHeight = $_aohs13i6jdxlevi4.getPreviewDialogHeight(editor);
    editor.windowManager.open({
      ...
      onPostRender: function (e) {
        ...
        $_ctmje4i7jdxlevi6.injectIframeContent(editor, iframeElm, sandbox);
      }
    });
  };
  var $_9jw12mi4jdxlevi2 = { open: open };

  var register = function (editor) {
    editor.addCommand('mcePreview', function () {
      $_9jw12mi4jdxlevi2.open(editor);
    });
  };
  var $_7hrjc3i3jdxlevhz = { register: register };
  ...
  var $_d9adx3i9jdxlevia = { register: register$1 };

  PluginManager.add('preview', function (editor) {
    $_7hrjc3i3jdxlevhz.register(editor);
    $_d9adx3i9jdxlevia.register(editor);
  });
  function Plugin () {
  }
