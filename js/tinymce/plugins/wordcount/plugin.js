...
var wordcount = (function () {
  ...
  var $_1u0rqts4jdxleyb7 = {
    each: each,
    map: map
  };

  var SETS$1 = $_80ozn3s2jdxleyb1.SETS;
  var OTHER = $_80ozn3s2jdxleyb1.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_1u0rqts4jdxleyb7.map(string.split(''), memoized);
  };
  var $_fk87v3s3jdxleyb4 = { classify: classify };

  var ci = $_80ozn3s2jdxleyb1.characterIndices;
  ...
  var $_249553s5jdxleybd = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_80ozn3s2jdxleyb1.EMPTY_STRING;
  var WHITESPACE$1 = $_80ozn3s2jdxleyb1.WHITESPACE;
  var PUNCTUATION$1 = $_80ozn3s2jdxleyb1.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_fk87v3s3jdxleyb4.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_249553s5jdxleybd.isWordBoundary(map, i)) {
  ...
  var $_931ye6s1jdxleyax = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_931ye6s1jdxleyax.getWords(getTextContent(editor)).length;
  };
  var $_76xx3js0jdxleyav = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_76xx3js0jdxleyav.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_c1qmherzjdxleyat = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return I18n.translate([
        '{0} words',
        $_76xx3js0jdxleyav.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_82956hs6jdxleybi = { setup: setup };

  PluginManager.add('wordcount', function (editor) {
    $_82956hs6jdxleybi.setup(editor);
    return $_c1qmherzjdxleyat.get(editor);
  });
  function Plugin () {
  }
