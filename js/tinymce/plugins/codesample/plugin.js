...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_4fjwyn9njdxletg4.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_a3cedl9jjdxlete4.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_4ep9mu9ljdxletea.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_dedv8a9ojdxletg9 = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_1v4emg9ijdxlete1 = {
    open: function (editor) {
      var minWidth = $_a3cedl9jjdxlete4.getDialogMinWidth(editor);
      var minHeight = $_a3cedl9jjdxlete4.getDialogMinHeight(editor);
      var currentLanguage = $_dedv8a9ojdxletg9.getCurrentLanguage(editor);
      var currentLanguages = $_dedv8a9ojdxletg9.getLanguages(editor);
      var currentCode = $_4ep9mu9ljdxletea.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_4ep9mu9ljdxletea.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_4fjwyn9njdxletg4.isCodeSample(node)) {
        $_1v4emg9ijdxlete1.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_16n5uj9hjdxletdy = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_4fjwyn9njdxletg4.trimArg($_4fjwyn9njdxletg4.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_4fjwyn9njdxletg4.trimArg($_4fjwyn9njdxletg4.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_4sb7mo9pjdxletgf = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_a3cedl9jjdxlete4.getContentCss(editor);
  ...
  var $_cq4z3k9qjdxletgi = { loadCss: loadCss };
  ...
  var $_e6a5qn9rjdxletgl = { register: register$1 };

  var addedInlineCss = Cell(false);
  PluginManager.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_4sb7mo9pjdxletgf.setup(editor);
    $_e6a5qn9rjdxletgl.register(editor);
    $_16n5uj9hjdxletdy.register(editor);
    editor.on('init', function () {
      $_cq4z3k9qjdxletgi.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_4fjwyn9njdxletg4.isCodeSample(ev.target)) {
        $_1v4emg9ijdxlete1.open(editor);
      }
    });
  });
