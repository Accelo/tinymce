...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_anpzh2e5jdxleuns.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_anpzh2e5jdxleuns.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_anpzh2e5jdxleuns.getSelectorConverter(editor)) {
      selectorConverter = $_anpzh2e5jdxleuns.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_anpzh2e5jdxleuns.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_anpzh2e5jdxleuns.getCssGroups(editor));
      ...
      if (!$_anpzh2e5jdxleuns.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      Tools.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_anpzh2e5jdxleuns.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_9cxeile0jdxleun5.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_91gg2zdzjdxleun0 = { get: get };

  PluginManager.add('importcss', function (editor) {
    $_9cxeile0jdxleun5.setup(editor);
    return $_91gg2zdzjdxleun0.get(editor);
  });
  function Plugin () {
  }
