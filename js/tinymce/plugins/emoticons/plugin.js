...
var emoticons = (function () {
  ...
  var $_bdrlj5ahjdxletoc = { getHtml: getHtml };
  ...
  var register = function (editor, pluginUrl) {
    var panelHtml = $_bdrlj5ahjdxletoc.getHtml(pluginUrl);
  ...
  var $_b299e1agjdxleto9 = { register: register };

  PluginManager.add('emoticons', function (editor, pluginUrl) {
    $_b299e1agjdxleto9.register(editor, pluginUrl);
  });
  function Plugin () {
  }
