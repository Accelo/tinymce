...
var contextmenu = (function () {
  ...
  var $_alh9g0a2jdxletkx = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_bzbgs6a1jdxletkg.getContextMenu(editor);
  ...
  var $_hrutpa5jdxletli = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_bzbgs6a1jdxletkg.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_hrutpa5jdxletli.show(editor, $_alh9g0a2jdxletkx.getPos(editor, e), visibleState, menu);
    });
  };
  var $_gh7vgxa0jdxletkb = { setup: setup };

  PluginManager.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_gh7vgxa0jdxletkb.setup(editor, visibleState, menu);
    return $_1eprvc9zjdxletk9.get(visibleState);
  });
  function Plugin () {
  }
