...
var tabfocus = (function () {
  ...
  var $_9jdzcjjmjdxlevsu = { getTabFocus: getTabFocus };
  ...
  var setup = function (editor) {
    function tabHandler(e) {
      ...
      v = Tools.explode($_9jdzcjjmjdxlevsu.getTabFocus(editor));
      if (v.length === 1) {
        v[1] = v[0];
        v[0] = ':prev';
      }
  ...
  var $_3itxwqjfjdxlevsc = { setup: setup };

  PluginManager.add('tabfocus', function (editor) {
    $_3itxwqjfjdxlevsc.setup(editor);
  });
  function Plugin () {
  }
