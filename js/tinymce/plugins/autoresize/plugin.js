...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_49zcrr8cjdxlet57.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_49zcrr8cjdxlet57.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_49zcrr8cjdxlet57.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_49zcrr8cjdxlet57.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_49zcrr8cjdxlet57.getAutoResizeBottomMargin(editor);
    ...
    if ($_49zcrr8cjdxlet57.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_evi94r89jdxlet4w.resize(editor, oldSize);
    });
  };
  var $_g0drya88jdxlet4r = { register: register };

  PluginManager.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_g0drya88jdxlet4r.register(editor, oldSize);
      $_evi94r89jdxlet4w.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
