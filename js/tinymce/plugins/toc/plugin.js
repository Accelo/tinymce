...
var toc = (function () {
  ...
  var $_4rrxj7qyjdxley1n = { create: create };

  var tocId = $_4rrxj7qyjdxley1n.create('mcetoc_');
  ...
  var readHeaders = function (editor) {
    var tocClass = $_1a1ouzqxjdxley1l.getTocClass(editor);
    var headerTag = $_1a1ouzqxjdxley1l.getTocHeader(editor);
    var selector = generateSelector($_1a1ouzqxjdxley1l.getTocDepth(editor));
  ...
  var generateTocHtml = function (editor) {
    ...
    return '<div class="' + editor.dom.encode($_1a1ouzqxjdxley1l.getTocClass(editor)) + '" contenteditable="false">' + html + '</div>';
  };
  var generateTocContentHtml = function (editor) {
    ...
    html += generateTitle($_1a1ouzqxjdxley1l.getTocHeader(editor), I18n.translate('Table of Contents'));
    for (i = 0; i < headers.length; i++) {
      h = headers[i];
      h.element.id = h.id;
  ...
  var register = function (editor) {
    editor.addCommand('mceInsertToc', function () {
      $_gfiwrxqtjdxley19.insertToc(editor);
    });
    editor.addCommand('mceUpdateToc', function () {
      $_gfiwrxqtjdxley19.updateToc(editor);
    });
  };
  var $_fl4jkiqsjdxley15 = { register: register };

  var setup = function (editor) {
    var $ = editor.$, tocClass = $_1a1ouzqxjdxley1l.getTocClass(editor);
  ...
  var $_g1i3ugqzjdxley1q = { setup: setup };

  var toggleState = function (editor) {
    return function (e) {
      var ctrl = e.control;
      editor.on('LoadContent SetContent change', function () {
        ctrl.disabled(editor.readonly || !$_gfiwrxqtjdxley19.hasHeaders(editor));
      });
    };
  };
  var isToc = function (editor) {
    return function (elm) {
      return elm && editor.dom.is(elm, '.' + $_1a1ouzqxjdxley1l.getTocClass(editor)) && editor.getBody().contains(elm);
    };
  };
  ...
  var $_v4z2pr0jdxley1t = { register: register$1 };

  PluginManager.add('toc', function (editor) {
    $_fl4jkiqsjdxley15.register(editor);
    $_v4z2pr0jdxley1t.register(editor);
    $_g1i3ugqzjdxley1q.setup(editor);
  });
  function Plugin () {
  }
